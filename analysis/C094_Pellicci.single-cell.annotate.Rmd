...
```{r heat-logFC, fig.asp = 2, fig.cap = sprintf("Heatmap of log-fold changes for the top 10 marker genes for cluster %s over all other clusters. Each column is a cluster, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", chosen), fig.asp = 0.7, layout = "l-body-outset"}
...
```{r heat-focused-logFC, fig.cap = sprintf("Heatmap of log-fold changes for cluster %s over all other clusters. Colours are capped at -3 and 3 to preserve dynamic range.", chosen), fig.asp = 0.7, layout = "l-body-outset"}
...
```{r heat-uniquely-up-logFC, fig.cap = sprintf("Heatmap of log-fold changes for cluster %s over all other clusters. Colours are capped at -3 and 3 to preserve dynamic range.", chosen), fig.asp = 0.7, layout = "l-body-outset"}
...
```{r heat-uniquely-up-logExp, fig.cap = sprintf("Heatmap of log-expression values in each sample for the top 25 uniquely upregulated marker genes in cluster %s. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", chosen), fig.asp = 0.9, layout="l-body-outset"}
plotHeatmap(
  sce,
  features = rownames(best_set),
  columns = order(
...
Similar figures showing the top 25 uniquely upregulated marker genes for each cluster are available in [`output/marker_genes/uniquely_up/heatmaps.uniquely_up.pdf`](../output/marker_genes/uniquely_up/heatmaps.uniquely_up.pdf).
