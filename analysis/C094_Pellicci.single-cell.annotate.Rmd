...
## Cluster (selected pairwise comparisons - integrated)
...
```{r qcplot-by-cluster-donor, fig.cap = "Distributions of various QC metrics for all single cells in the dataset, stratified by cluster and donor This includes the library sizes, number of expressed genes, and proportion of reads mapped to spike-in transcripts or mitochondrial genes.", layout = "l-page", fig.asp = 0.7}
plot_grid(
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/integrated/`](..output/marker_genes/uniquely_up/integrated/).
