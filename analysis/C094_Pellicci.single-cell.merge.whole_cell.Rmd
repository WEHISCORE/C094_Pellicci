---
title: "Merging cells for Pellicci gamma-delta T-cell single-cell dataset (whole cell)"
description: |
author:
  - name: William Ho 
...
knitr::opts_chunk$set(fig.path = "C094_Pellicci.single-cell.merge.whole_cell_files/")
```
...
We re-process the *whole cell* remained in the dataset.
