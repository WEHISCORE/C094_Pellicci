...
For instance, unique markers of cluster `13` refer to the genes significantly up-regulated in **all** of these comparisons: cluster `14` vs. `13` **and** cluster `15` vs. `13` **and** cluster `16` vs. `13`.
...
For the thymus.S3 subgroups, we did try to test if they are truly different, but based on the outcome of our statistical DE test, these sub-groups show no difference from each other and thus should be combined.
