...
saveRDS(
  sce,
  here("data", "SCEs", "C094_Pellicci.single-cell.cells_selected.SCE.rds"),
  compress = "xz")
```

The processed *SingleCellExperiment* object is available (see [`data/SCEs/C094_Pellicci.cells_selected.SCE.rds`](../data/SCEs/C094_Pellicci.single-cell.cells_selected.SCE.rds)).
