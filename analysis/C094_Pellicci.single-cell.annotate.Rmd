...
```{r heat-uniquely-up-logExp-cluster-1, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  sce,
...
```{r heat-uniquely-up-logExp-cluster-2, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  sce,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-3, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  sce,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-4, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  sce,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_1_vs_2_vs_3_vs_4/`](..output/marker_genes/uniquely_up/cluster_1_vs_2_vs_3_vs_4/).
...
## Cluster (selected pairwise comparisons)
...
```{r heat-uniquely-up-logExp-cluster-1-2-4-vs-3, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-3-vs-1-2-4, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_1_2_4_vs_3/`](..output/marker_genes/uniquely_up/cluster_1_2_4_vs_3/).
...
```{r heat-uniquely-up-logExp-cluster-1-2-vs-3, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-3-vs-1-2, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_1_2_vs_3/`](..output/marker_genes/uniquely_up/cluster_1_2_vs_3/).
...
```{r heat-uniquely-up-logExp-cluster-1-2-vs-4, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-4-vs-1-2, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_1_2_vs_4/`](..output/marker_genes/uniquely_up/cluster_1_2_vs_4/).
...
```{r heat-uniquely-up-logExp-cluster-1-vs-2, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-2-vs-1, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_1_vs_2/`](..output/marker_genes/uniquely_up/cluster_2_vs_1/).
...
```{r heat-uniquely-up-logExp-cluster-3-vs-4, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-4-vs-3, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_3_vs_4/`](..output/marker_genes/uniquely_up/cluster_3_vs_4/).
...
```{r heat-uniquely-up-logExp-cluster-2-vs-3, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-3-vs-2, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_2_vs_3/`](..output/marker_genes/uniquely_up/cluster_2_vs_3/).
...
```{r heat-uniquely-up-logExp-cluster-2-vs-4, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-4-vs-2, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_2_vs_4/`](..output/marker_genes/uniquely_up/cluster_2_vs_4/).
...
```{r heat-uniquely-up-logExp-cluster-1-vs-3, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-3-vs-1, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_1_vs_3/`](..output/marker_genes/uniquely_up/cluster_1_vs_3/).
...
```{r heat-uniquely-up-logExp-cluster-1-vs-4, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
```{r heat-uniquely-up-logExp-cluster-4-vs-1, fig.cap = "Heatmap of log-expression values in each sample for the top uniquely upregulated marker genes. Each column is a sample, each row a gene. Colours are capped at -3 and 3 to preserve dynamic range.", fig.asp = 1.2, layout="l-body-outset"}
# heatmap
plotHeatmap(
  cp,
  features = rownames(best_set),
...
DGE lists of these comparisons are available in [`output/marker_genes/uniquely_up/cluster_1_vs_4/`](..output/marker_genes/uniquely_up/cluster_1_vs_4/).
...
**Summary**: The next two clusters I would like to talk about is cluster 1 and 2 (Figure \@ref(fig:clusterplot-umap)).
Cell-types/ -stages of cluster `1` and cluster `2` are highly similar as implied by their UMAP distribution. 
