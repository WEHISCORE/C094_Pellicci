...
mnn_out_0 <- fastMNN(
  ...
  restrict = list(tmp$sample_name == "Cell line"), 
  subset.row = hvg)
...
p3 <- plotReducedDim(sce, "UMAP", colour_by = "sample_name") + 
  scale_colour_manual(values = sample_name_colours, name = "sample_name")
p4 <- plotReducedDim(sce, "UMAP_corrected", colour_by = "sample_name") + 
  scale_colour_manual(values = sample_name_colours, name = "sample_name")
...
p7 <- plotReducedDim(sce, "UMAP", colour_by = "post_hoc_sample_gate") + 
  scale_colour_manual(values = sample_gate_colours, name = "post_hoc_sample_gate")
p8 <- plotReducedDim(sce, "UMAP_corrected", colour_by = "post_hoc_sample_gate") + 
  scale_colour_manual(values = sample_gate_colours, name = "post_hoc_sample_gate")
