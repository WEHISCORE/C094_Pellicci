...
# i.e.
# backup SCE
# subset to remove plate LCE511
# use plate remained to find marker for "groups = sample_name" ?
# heatmap
# then reapply the following scrip to look for row O and row P marker
# see if row O got both marker from thymus 2 and blood 2 ???
