...
**TODO: double check if I under the comparisons above correctly**
**TODO: check with Pete - do I need to block on `donor` as well ? **
...
**TODO: check if `sample` should be set like this instead ?**
...
columns_to_keep <- c("plate_number", "sequencing_run", "sex", "strain")
...
assay(summed, "correctedLogCPM") <- limma::removeBatchEffect(
  assay(summed, "logCPM"), 
  batch = summed$sequencing_run,
  design = model.matrix(~strain, colData(summed)))
```
