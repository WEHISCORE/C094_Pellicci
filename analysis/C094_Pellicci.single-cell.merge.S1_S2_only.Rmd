---
title: "Merging cells for Pellicci gamma-delta T-cell single-cell dataset (S1 and S2 only)"
description: |
author:
  - name: William Ho 
...
knitr::opts_chunk$set(fig.path = "C094_Pellicci.single-cell.merge.S1_S2_only_files/")
```
...
We re-process the cells from *S1 and S2 only* remained in the dataset.
...
saveRDS(
  sce,
  here("data", "SCEs", "C094_Pellicci.single-cell.merged.S1_S2_only.SCE.rds"),
  compress = "xz")
```

The processed *SingleCellExperiment* object is available (see [`data/SCEs/C094_Pellicci.single-cell.merged.S1_S2_only.SCE.rds`](../data/SCEs/C094_Pellicci.single-cell.merged.S1_S2_only.SCE.rds)).
