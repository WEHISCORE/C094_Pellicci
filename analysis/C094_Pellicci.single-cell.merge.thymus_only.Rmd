...
saveRDS(
  sce,
  here("data", "SCEs", "C094_Pellicci.single-cell.merge.thymus_only.SCE.rds"),
  compress = "xz")
```

The processed *SingleCellExperiment* object is available (see [`data/SCEs/C094_Pellicci.single-cell.merge.thymus_only.SCE.rds`](../data/SCEs/C094_Pellicci.single-cell.merge.thymus_only.SCE.rds)).
