# EDA: annotate (whole cell) (without removal of "unknown")
# William Ho
# 2021-08-06
...
# I decide to go for 4 clusters, as it seem sto be able to further divide the S3
4
...
###################################
# cluster 1 (i.e. mostly thymus.s1.s2) vs 2 (i.e. S3-mix, low blood) vs 3 (i.e. S3-mix, high blood) vs 4 (i.e. S3-mix, mid blood)
...
##########################################
# look at cluster 1 (i.e. mostly thymus.s1.s2)
chosen <- "1"
...
##########################################
# look at cluster 2 (i.e. S3-mix, low blood)
chosen <- "2"
...
##########################################
# look at cluster 4 (i.e. S3-mix, mid blood)
chosen <- "4"
...
# i.e. combine cluster 3 and 4, cluster 1 standalone, cluster 2 standalone
sce$cg <- factor(
  dplyr::case_when(
    sce$cluster == "1" ~ "A",
    sce$cluster == "2" ~ "B",
...
###################################
# cluster A (i.e. mostly thymus.s1.s2) vs B (i.e. S3-mix, less blood) vs C (i.e. S3-mix, more blood)
...
##########################################
# look at cluster A (i.e. mostly thymus.s1.s2)
chosen <- "A"
...
##########################################
# look at cluster B (i.e. S3-mix, less blood)
chosen <- "B"
...
##########################################
# look at cluster C (i.e. S3-mix, more blood)
chosen <- "C"
