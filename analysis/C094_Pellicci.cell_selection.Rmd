...
example_label <- "Intermediate monocytes"
...
reducedDim(sce2, "corrected_3") <- reducedDim(mnn_out_0, "corrected")
...
set.seed(11901)
sce2 <- runUMAP(sce2, dimred = "corrected_3", name = "UMAP_corrected_3")
corrected_umap_3 <- cbind(
  data.frame(
    x = reducedDim(sce2, "UMAP_corrected_3")[, 1],
    y = reducedDim(sce2, "UMAP_corrected_3")[, 2]),
  as.data.frame(colData(sce2)))

# re-clustering after each MNN correction
set.seed(4759)
snn_gr_3 <- buildSNNGraph(sce2, use.dimred = "corrected_3")
