...
CSV file of results available from [`output/DEGs/excluding_blood_1-3/aggregated_tech_reps.DEGs.csv.gz`](../output/DEGs/excluding_blood_1-3/aggregated_tech_reps.DEGs.csv.gz).
