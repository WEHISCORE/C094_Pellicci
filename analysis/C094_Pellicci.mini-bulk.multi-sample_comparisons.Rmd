...
We exclude samples with < 100,000 reads.

```{r}
# TODO: Any other filters
sce <- sce[, sce$nreads >= 100000]
```
...
# TODO: Blood on donor or plate_number? Think the former
...
```{r, fig.cap = "MD plots highlighting DEGs (red).", fig.asp = 1, results = "hide"}
par(mfrow = c(2, 2))
...
Figure \@ref(fig:heatmap-y-1) - \@ref(fig:heatmap-y-3) are heatmaps showing the expression of the DEGs.
