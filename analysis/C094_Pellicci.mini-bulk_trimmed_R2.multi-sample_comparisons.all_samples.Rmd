...
<aside>
PDF versions of these figures are available in [`output/DEGs/all_samples/violin_plots/logCPM.pdf`](../output/DEGs/all_samples/violin_plots/logCPM.pdf) and [`output/DEGs/all_samples/violin_plots/batch-corrected_logCPM.pdf`](../output/DEGs/all_samples/violin_plots/batch-corrected_logCPM.pdf).
</aside>
...
CSV files of the results are available from [`output/DEGs/all_samples/`](../output/DEGs/all_samples/).
