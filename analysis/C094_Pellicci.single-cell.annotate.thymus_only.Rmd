...
plotHeatmap(
  ...
  annotation_row = data.frame(
    ...
    thymus.s3.vs.thymus.s2 = factor(ifelse(minibulk_markers_down %in% top.uniq.minibulkDEG.c.down, "DE", "not DE"), levels = c("DE")),
    row.names = minibulk_markers_down),
  main = "Row-normalized log expression of top unique markers from minibulk (down-regulated) against different groups",
  column_annotation_colors = list(
    group = group_colours,
    stage = stage_colours,
    tissue = tissue_colours,
...
plotHeatmap(
  ...
  annotation_row = data.frame(
    ...
    thymus.s3.vs.thymus.s2 = factor(ifelse(minibulk_markers_down %in% top.uniq.minibulkDEG.c.down, "DE", "not DE"), levels = c("DE")),
    row.names = minibulk_markers_down),
  main = "Row-normalized log expression of top unique markers from minibulk (down-regulated) against different groups (column-clustered)",
  column_annotation_colors = list(
    group = group_colours,
    stage = stage_colours,
    tissue = tissue_colours,
