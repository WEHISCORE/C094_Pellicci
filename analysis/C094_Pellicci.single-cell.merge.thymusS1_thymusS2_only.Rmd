---
title: "Merging cells for Pellicci gamma-delta T-cell single-cell dataset (thymus.S1 and thymus.S2 only)"
description: |
author:
  - name: William Ho 
...
knitr::opts_chunk$set(fig.path = "C094_Pellicci.single-cell.merge.thymus.S1_thymus.S2_only_files/")
```
...
We re-process the cells from *thymus.S1 and thymus.S2 only* remained in the dataset.
...
- cells in all four clusters are  mixture of `S1` and `S2` cells
- plate-specific batch effect seems quite prominent without MNN correction
...
saveRDS(
  sce,
  here("data", "SCEs", "C094_Pellicci.single-cell.merged.thymusS1_thymusS2_only.SCE.rds"),
  compress = "xz")
```

The processed *SingleCellExperiment* object is available (see [`data/SCEs/C094_Pellicci.single-cell.merged.thymusS1_thymusS2_only.SCE.rds`](../data/SCEs/C094_Pellicci.single-cell.merged.thymusS1_thymusS2_only.SCE.rds)).
