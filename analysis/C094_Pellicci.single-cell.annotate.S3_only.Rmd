...
<aside>
PDF version of this figure is available in [`output/figures/clusterplot-umap.single-cell.annotate.S3_only.pdf`](../output/figures/clusterplot-umap.single-cell.annotate.S3_only.pdf).
</aside>
...
<aside>
PDF version of this figure is available in [`output/figures/cluster-barplot.single-cell.annotate.S3_only.pdf`](../output/figures/cluster-barplot.single-cell.annotate.S3_only.pdf).
</aside>
...
<aside>
A PDF showing the top-20 markers in each cluster is shown in [`output/figures/heat-uniquely-up-logExp.annotate.S3_only.pdf`](../output/figures/heat-uniquely-up-logExp.annotate.S3_only.pdf).
</aside>
