...
donor_colours <- setNames(
  palette.colors(nlevels(sce$donor), "Dark 2"),
  levels(sce$donor))
...
plotHeatmap(
  ...
  column_annotation_colors = list(
    sample_name = sample_name_colours[levels(w$sample_name)],
...
```{r}
remove_p <- sce$plate_number == "LCE511" & substr(sce$well_position, 1, 1) == "P"
sce <- sce[, !remove_p]
```
...
```{r}
remove_o <- sce$plate_number == "LCE511" & substr(sce$well_position, 1, 1) == "O"
sce <- sce[, !remove_o]
