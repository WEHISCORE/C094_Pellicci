...
pdf(
  here("tmp/clusterplot-umap.single-cell.annotate.S3_only.pdf"),
  height = 7.5, 
  width = 6)
(p1 | p2) / (p3 | p4) / (p5 | p6)
dev.off()
...
# NOTE: A potential figure for supplementary material.
pdf(
  here("tmp/cluster-barplot.single-cell.annotate.S3_only.pdf"),
  height = 6, 
  width = 6)
(p1 | p2) / (p3 | p4) / (p5 | p6)
dev.off()
...
pdf(
  here("tmp/heat-uniquely-up-logExp.annotate.S3_only.pdf"), 
  height = 12, 
  width = 10)
plotHeatmap(
  sce,
