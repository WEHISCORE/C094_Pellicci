...
Together with the cells with `Unknown` stage, all should be removed from the the subsequent analyses as well.
...
saveRDS(
  sce,
  here("data", "SCEs", "C094_Pellicci.single-cell.cell_selection.SCE.rds"),
  compress = "xz")
```

The processed *SingleCellExperiment* object is available (see [`data/SCEs/C094_Pellicci.single-cell.cell_selection.SCE.rds`](../data/SCEs/C094_Pellicci.single-cell.cell_selection.SCE.rds)).
