...
# EDA to look for best merge order (thymus.S1 and thymus.S2 only)
# William Ho
# 12-08-2021
...
### thymus.S1 and thymus.S2 only
sce <- sce[, sce$tissue == "Thymus" & sce$stage == "S1 (CD4+/CD161-)" | sce$tissue == "Thymus" & sce$stage == "S2 (CD4-/CD161-)"]
