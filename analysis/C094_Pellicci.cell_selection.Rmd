...
**TODO: double check this note**
  ...
  1) shifting of cells P6 to P7, then P8 in unmerge and even all merges
  2) blood contains cells at the final P8 stage, while thymus contain cells from all 4 stage
  3) small bit of thymus cells seems to transccriptonally superimpoed with the SKW3 cell line
